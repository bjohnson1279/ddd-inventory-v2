...
const JWT_SECRET = process.env.JWT_SECRET || "dummy_dev_secret_please_change_in_production";
if (!process.env.JWT_SECRET) {
  console.warn("WARNING: JWT_SECRET environment variable is not set. Using insecure development default secret. Please configure JWT_SECRET in production.");
}
